...
Feature: MI_DP1.feature
  ...
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
      | State |
      | MI    |
    ...
    Then Enter Insured Details Firstname/ LastName/ Adress/ zipcode/ Date of birth |  userEntersText
      ...
      | basicinformationapage.insuredlastName  | Test MI      |
      | basicinformationapage.riskStreet       | 8067 Chatham |
      | basicinformationapage.riskUnitAPTLOT   |            1 |
      | basicinformationapage.riskCity         | Alexandria   |
      | basicinformationapage.riskZipcode      |        48239 |
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state MI with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as MI | SelectObject
