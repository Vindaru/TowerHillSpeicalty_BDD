...
public class HO6  extends ExcelUtils{

    //given, When ,There
    
    public static void main(String[] args) throws Exception {
           
     ExcelUtils.setExcelFile(API_Constant_Values.HO6_Path_TestData + API_Constant_Values.HO6_File_TestData, "sheet1");		
	int i, j;
  ...
  // Write in Excel 
		     ...
		     ExcelUtils.ExcelWSheet.getRow(a).createCell(2).setCellValue(Premium);
	             ...
	             FileOutputStream fos=new FileOutputStream(API_Constant_Values.HO6_Path_TestData + API_Constant_Values.HO6_File_TestData);			
