...
Feature: NC_DP1.feature
  ...
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
      | State |
      | NC    |
    ...
    Then Enter Insured Details Firstname/ LastName/ Adress/ zipcode/ Date of birth |  userEntersText
      ...
      | basicinformationapage.insuredlastName  | Test NC          |
      | basicinformationapage.riskStreet       | 3655 Vallette Ct |
      | basicinformationapage.riskUnitAPTLOT   |                1 |
      | basicinformationapage.riskCity         | Charlotte        |
      | basicinformationapage.riskZipcode      |            28203 |
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state NC with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as NC | SelectObject
