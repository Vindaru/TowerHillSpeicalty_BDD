...
Feature: AZ_DP1.feature
  ...
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
      | State |
      | AZ    |
    ...
    Then Enter Insured Details Firstname/ LastName/ Adress/ zipcode/ Date of birth |  userEntersText
      ...
      | basicinformationapage.insuredlastName  | Test AZ             |
      | basicinformationapage.riskStreet       | 15240 N Clubgate Dr |
      | basicinformationapage.riskUnitAPTLOT   |                 121 |
      | basicinformationapage.riskCity         | Scottsdale          |
      | basicinformationapage.riskZipcode      |               85254 |
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/ACV
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Owner/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Seasonal/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Rental/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Vacant/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
  ...
  @BasicInformationPage
  Scenario: Verify valid agent is successfully able create a policy in state AZ with riskaddress "NOT COSTAL" with Occupancy as Not A Residence/DP1/Full Repair Cost
    Given Internal Agent is logged in to RPM home page | verify next page title
      | pageTitle                                          |
      | RPM –  Tower Hill Insurance – Tower Hill Insurance |
    Then Select State as AZ | SelectObject
