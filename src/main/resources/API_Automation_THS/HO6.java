...
public class HO6  extends ExcelUtils{
    ...
    public static void main(String[] args) throws Exception {
     ...
     ExcelUtils.setExcelFile(Constant.HO6_Path_TestData + Constant.HO6_File_TestData, "sheet1");		
	int i, j;
  ...
  // Write in Excel 
		     ...
		     ExcelUtils.ExcelWSheet.getRow(a).createCell(2).setCellValue(Premium);
	             ...
	             FileOutputStream fos=new FileOutputStream(Constant.HO6_Path_TestData + Constant.HO6_File_TestData);			
